...
public class TextEditor extends DialogFragment {
    public static final String TAG = TextEditor.class.getSimpleName();
    ...
    public static TextEditor show(@NonNull AppCompatActivity appCompatActivity,
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mAddTextEditText = view.findViewById(R.id.tvEditText);
        mInputMethodManager = (InputMethodManager) getActivity().getSystemService(Context.INPUT_METHOD_SERVICE);
        mAddTextDoneTextView = view.findViewById(R.id.tvDone);

        //Setup the color picker for text color
        RecyclerView addTextColorPickerRecyclerView = view.findViewById(R.id.rvTextColorPicker);
    ...
    public void setOnTextEditorListener(AddText addText) {
        mTextEditor = addText;
    }
}
